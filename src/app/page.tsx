...
export default function Home() {
	...
	const onClickOn = (id: number) => {
		const urlPage = {
			face: "fb://profile/100006502689663",
			ins: "instagram://user?username=dilv.98",
			zalo: "https://www.zalo.me/0845000408",
		};
				...
				<div className="w-[100%] h-[100%] flex flex-col gap-5 items-center pb-3">
					<article className="cta" onClick={() => onClickOn(0)}>
						<div className="cta__text-column">
							...
							<p>Instagram</p>
							<a href="instagram://user?username=dilv.98">
					...
					<article className="cta" onClick={() => onClickOn(1)}>
						<div className="cta__text-column">
							...
							<p>Facebook</p>
							<a href="fb://profile/100006502689663">
								<FaArrowRightToBracket />
							</a>
						</div>
					</article>
					<article className="cta" onClick={() => onClickOn(2)}>
						<div className="cta__text-column">
							...
							<p>Zalo</p>
							<a href="https://www.zalo.me/0845000408">
								<FaArrowRightToBracket />
							</a>
						</div>
					</article>
