...
const Modal = ({ isOpen, onClose }: propsModal) => {
    ...
    const handleSave = async () => {
		...
		const textToCopy = "64649999999999";
        try {
            setIsOpenCp(true);
		...
		<div className="fixed right-0 bottom-0 top-0 left-0 bg-[rgba(100,100,100,0.5)]">
			<div className="bg-white overflow-hidden max-w-[400px] w-[90%] rounded-lg p-4 absolute opacity-1 text-black top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
				<div style={{ border: "2px solid rgb(0,191,255)" }}>
					...
					<p className="text-center font-semibold">( Techcombank ) Lam Van Di</p>
					<div className="flex items-center justify-center">
						<p className="text-center font-bold">64649999999999</p>
						<VscCopy
				...
				<a href="https://me.momo.vn/dilv4898" className="flex justify-center items-center p-2 " style={{border:"2px solid rgb(0,191,255)"}}><Image src={momo} alt="momo"></Image></a>
